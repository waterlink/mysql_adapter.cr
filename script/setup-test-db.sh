...
mysql $PARAMS -e "use crystal_mysql_test; drop table if exists people; create table people( id int not null auto_increment primary key, last_name varchar(50), first_name varchar(50), number_of_dependents int )"
